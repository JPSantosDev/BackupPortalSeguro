...
if ($acao === 'salvar') {
    ...
    if ((int) $stmt->fetch()['c'] > 0) {
        flashSet('danger', 'Não é possível excluir: este tipo já está em uso em denúncias.');
    } else {
