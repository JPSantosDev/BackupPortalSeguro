...
$stmt = $pdo->prepare('SELECT d.*, t.nome AS tipo_nome, u.nome AS denunciante_nome, u.email AS denunciante_email, u.turma
                        FROM denuncias d
...
<div class="detail-grid">
  ...
  <div class="card">
    ...
    <div class="meta-row"><span class="k">Denunciante</span><span class="v"><?= $d['anonima'] ? 'Anônima' : htmlspecialchars($d['denunciante_nome'] ?? 'Aluno removido') ?></span></div>
    <?php if (!$d['anonima']): ?>
