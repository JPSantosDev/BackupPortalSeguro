...
<?php if ($tipo === 1): ?>
  <div class="grid-cards">
    ...
    <div class="stat-card c-blue"><div class="bar"></div><div class="value"><?= array_sum($porStatus) ?></div><div class="label">Total enviadas</div></div>
  </div>
  ...
  <div class="grid-cards" style="grid-template-columns: repeat(auto-fit, minmax(260px,1fr));">
    <a class="action-card" href="denuncia_nova.php">
      <div class="icon-wrap"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 8v8M8 12h8"/></svg></div>
      <div><h3>Nova denúncia</h3><p>Relate uma situação de bullying de forma rápida e, se preferir, anônima.</p></div>
    </a>
    <a class="action-card" href="minhas_denuncias.php">
      <div class="icon-wrap"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 2h6l1 3H8l1-3z"/><path d="M6 6h12l-1 15H7L6 6z"/></svg></div>
      <div><h3>Minhas denúncias</h3><p>Veja o status e as respostas da equipe de apoio sobre seus relatos.</p></div>
    </a>
  </div>
